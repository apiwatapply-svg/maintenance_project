...
router.get("/returnable", requireToolingAccess("admin"), toolingController.getReturnableQuantity);
router.post("/return", requireToolingAccess("admin"), toolingController.returnItem);
router.get("/history", requireToolingAccess("admin"), toolingController.history);
