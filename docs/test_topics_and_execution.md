...
| 20 | Full frontend unit suite | `cd frontend && npm test` | Passed 2026-05-16, 76 tests |
...
| 5 | Full feature E2E workflow | `node scripts/run_full_e2e_checks.js` against local backend/frontend/MSSQL | Passed 2026-05-16, 18/18 topics including all-route, MMS overlay, report calculations, future-hour labels with zero actuals and normal targets, mock scan, and UI guardrails |
...
- Full feature E2E passed 18/18 topics: health, role matrix, MMS MSSQL API, admin CRUD, tooling stock/borrow/calibration, job request workflow, preventive workflow, MMS realtime payload, protected frontend routes, browser-created Job Request, MMS realtime DOM updates, MMS Excel export downloads, all App Router routes, Job Request to MMS active overlay, MMS daily/monthly/yearly report calculations, future-hour MMS report labels with zero actuals and normal targets, frontend source mock scan, and responsive UI guardrails.
