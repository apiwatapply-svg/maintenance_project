...
| 5 | Full feature E2E workflow | `node scripts/run_full_e2e_checks.js` against local backend/frontend/MSSQL | Passed 2026-05-16, 18/18 topics including all-route, MMS overlay, report calculations, no-future-hour MMS reports, mock scan, and UI guardrails |
